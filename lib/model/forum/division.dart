...
class OTDivision {
  ...
  // A special division id `0` is used to represent the home page.
  // It is guaranteed by the server that no division with ID 0 will be provided. 
  static const int HOME_PAGE_DIVISION_ID = 0;
}
