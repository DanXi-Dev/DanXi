...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m5(mostCrowded, leastCrowded) =>
      "[Most Crowded]${mostCrowded}餐厅 [Least Crowded]${leastCrowded}餐厅";

  static m6(name) => "Reply No.${name}";

  static m7(num) => "${num} sec(s) ago";

  static m8(week) => "Week ${week}";
  ...
  static _notInlinedMessages(_) => <String, Function>{
    ...
    "change_account" : MessageLookupByLibrary.simpleMessage("Switch Account"),
        ...
        "dev_image_url_4":
            MessageLookupByLibrary.simpleMessage("assets/graphics/hasbai.jpeg"),
        ...
        "dev_page_4":
            MessageLookupByLibrary.simpleMessage("https://github.com/hasbai"),
