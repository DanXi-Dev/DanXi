...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(date) => "DevTeam Announcement ${date}";

  static m1(time) => "Automatic check-in in ${time} seconds. Tap to cancel.";

  static m2(mostCrowded, leastCrowded) =>
      "[Most Crowded]${mostCrowded}餐厅 [Least Crowded]${leastCrowded}餐厅";

  static m3(name) => "Reply No.${name}";

  static m4(week) => "Week ${week}";
  ...
  static _notInlinedMessages(_) => <String, Function>{
    ...
    "dashboard" : MessageLookupByLibrary.simpleMessage("Dashboard"),
        ...
        "dev_image_url_1":
            MessageLookupByLibrary.simpleMessage("assets/graphics/w568w.jpeg"),
        "dev_image_url_2": MessageLookupByLibrary.simpleMessage(
            "assets/graphics/kavinzhao.jpeg"),
        "dev_image_url_3":
            MessageLookupByLibrary.simpleMessage("assets/graphics/kyln24.jpeg"),
        "dev_name_1": MessageLookupByLibrary.simpleMessage("Xu Dong\n[w568w]"),
        "dev_name_2":
            MessageLookupByLibrary.simpleMessage("Zhao Xingjian\n[kavinzhao]"),
        "dev_name_3":
            MessageLookupByLibrary.simpleMessage("Guo Honglin\n[KYLN24]"),
        "dev_page_1":
            MessageLookupByLibrary.simpleMessage("https://github.com/w568w"),
        "dev_page_2": MessageLookupByLibrary.simpleMessage(
            "https://github.com/kavinzhao"),
        "dev_page_3":
            MessageLookupByLibrary.simpleMessage("https://github.com/KYLN24"),
        "developer_announcement": m0,
        "dining_hall_crowdedness":
            MessageLookupByLibrary.simpleMessage("Canteen Popularity"),
        ...
        "fudan_daily": MessageLookupByLibrary.simpleMessage(
            "Automatic COVID-19 Safety Check-In"),
        "fudan_daily_tick":
            MessageLookupByLibrary.simpleMessage("Tap to check in"),
        "fudan_daily_tick_countdown": m1,
        "fudan_daily_ticked":
    ...
    "login_uis_description" : MessageLookupByLibrary.simpleMessage("Your login information is only sent to Fudan servers via secure connection."),
        ...
        "login_with_uis":
            MessageLookupByLibrary.simpleMessage("Sign in anonymously as:"),
