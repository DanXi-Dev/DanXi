...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "lan_connection_issue_1_guide_content" : MessageLookupByLibrary.simpleMessage("3 simple steps:<br /><br />1. <a href=\"https://stuvpn.fudan.edu.cn/com/installClient.html#auto-common\">Click here</a> to the download page and select the corresponding platform to install.<br />2. Open the installed app and type in the Address stuvpn.fudan.edu.cn, click OK。<br />3. A login page pops up. Enter your UIS account & password.<br /><br />Then All the functions of DanXi will work normally!"),
