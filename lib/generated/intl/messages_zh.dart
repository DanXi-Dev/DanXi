...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "forum" : MessageLookupByLibrary.simpleMessage("树洞"),
        ...
        "fudan_daily_disabled_notice":
            MessageLookupByLibrary.simpleMessage("应校方要求，自动打卡功能不再可用，敬请谅解。"),
        "fudan_daily_tick":
            MessageLookupByLibrary.simpleMessage("[警告：该功能仅限DEBUG使用] 点击自动打卡"),
        "fudan_daily_tick_countdown": m4,
        "fudan_daily_tick_link":
            MessageLookupByLibrary.simpleMessage("今日未打卡，点击打开打卡页面"),
        ...
        "image_save_failed":
            MessageLookupByLibrary.simpleMessage("图片保存失败，请检查您的权限设置"),
        ...
        "lan_connection_issue_1":
            MessageLookupByLibrary.simpleMessage("未能连接到校园内网"),
        "lan_connection_issue_1_action":
            MessageLookupByLibrary.simpleMessage("校园 VPN"),
        "lan_connection_issue_1_description": MessageLookupByLibrary.simpleMessage(
            "无法连接到复旦内部网络，部分功能不可用。您是否在校外或使用了移动数据链接？\n\n您可以使用校园 VPN(Easy Connect) 或链接 Eduroam 热点以访问内网资源。"),
        "lan_connection_issue_1_guide_content":
            MessageLookupByLibrary.simpleMessage(
                "三步走即可:<br /><br />1. <a href=\"https://stuvpn.fudan.edu.cn/com/installClient.html#auto-common\">点击这里</a>去VPN下载界面，选择对应平台安装。<br />2. 打开安装的软件，在地址栏输入 stuvpn.fudan.edu.cn ，点击确定。<br />3. 弹出登录界面，输入自己的UIS账号，点击连接。<br /><br />然后就可以正常使用旦夕各项功能了！"),
        "lan_connection_issue_1_guide_title":
            MessageLookupByLibrary.simpleMessage("如何使用校园 VPN？"),
        ...
        "loading_bbs_secure_connection":
            MessageLookupByLibrary.simpleMessage("正在进行服务器安全性检查，请稍等..."),
        "loading_qr_code": MessageLookupByLibrary.simpleMessage(
            "正在加载复活码...\n可能需要5~10秒，取决于复旦服务器。"),
        "location_permission_denied_promot":
            MessageLookupByLibrary.simpleMessage(
                "位置信息不可用，您将无法在app中打卡平安复旦。如果希望重新授予定位权限，请在设置中更改定位服务授权。"),
    ...
    "login_issue_2" : MessageLookupByLibrary.simpleMessage("未能正确从服务器获取本学期相关信息，请重试。\n如果直接跳过，课程表相关功能可能出现日期计算上的问题。"),
