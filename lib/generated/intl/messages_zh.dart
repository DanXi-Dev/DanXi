...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "comma_least_crowded_canteen_is" : MessageLookupByLibrary.simpleMessage("，排队人数最少的餐厅是"),
    ...
    "login_with_uis" : MessageLookupByLibrary.simpleMessage("将使用以下信息匿名登录树洞"),
        ...
        "logout_question_prompt":
            MessageLookupByLibrary.simpleMessage("删除数据后，此app将会退出"),
        ...
        "most_crowded_canteen_currently_is":
            MessageLookupByLibrary.simpleMessage("当前排队人数最多的餐厅是"),
