...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "good_night" : MessageLookupByLibrary.simpleMessage("晚上好~"),
        ...
        "need_campus_network":
            MessageLookupByLibrary.simpleMessage("注意：你可能需要连接到校园内网才能访问这些数据。"),
        "new_post": MessageLookupByLibrary.simpleMessage("发布新帖子"),
        "new_shortcut_card": MessageLookupByLibrary.simpleMessage("添加快捷卡片"),
        "new_shortcut_description":
            MessageLookupByLibrary.simpleMessage("点击该卡片可以打开指定网页"),
        "next_course_is": m9,
    ...
    "no_data" : MessageLookupByLibrary.simpleMessage("数据为空"),
        ...
        "reorder_hint": MessageLookupByLibrary.simpleMessage(
            "长按并拖动下列条目以重新排列主页卡片。\n滑动以删除辅助卡片。"),
        "reply_failed": m11,
        "reply_to": m12,
        ...
        "unable_to_access_url":
            MessageLookupByLibrary.simpleMessage("测试连接失败\n无法访问此网页，请检查URL"),
