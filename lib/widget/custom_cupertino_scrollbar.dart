...
/// a [CustomCupertinoScrollbar] widget.
///
/// {@macro flutter.widgets.Scrollbar}
///
/// When dragging a [CustomCupertinoScrollbar] thumb, the thickness and radius will
...
class CustomCupertinoScrollbar extends RawScrollbar {
  ...
  /// Default value for [thickness] if it's not specified in [CustomCupertinoScrollbar].
  ...
  /// Default value for [radius] if it's not specified in [CustomCupertinoScrollbar].
  static const Radius defaultRadius = Radius.circular(3.0);
...
class _CupertinoScrollbarState extends RawScrollbarState<CustomCupertinoScrollbar> {
